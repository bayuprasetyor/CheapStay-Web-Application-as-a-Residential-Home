...
<div class="header">
		   <div class="col-sm-8 header-left">
                  ...
                  if($_SESSION['level']==2){
                    echo "<li  class='active'><a href='booking.php'>Daftar Booking</a></li>";
                  }
            ...
            <div class="banner-bottom">
               <table id="datatable" class="stripe">
                  ...
                  <tbody>
                      ...
                      $query = "SELECT * from pemesan,penginapan where pemesan.id_hotel=penginapan.id and pemesan.id_user = $id_user";

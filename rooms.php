...
<div class="header">
   ...
   <div class="living_middle">
        ...
        try{
            ...
            $sqlQuery = "SELECT * FROM penginapan where jenis = '$jenis' and lokasi = '$lokasi'";
		...
		$_SESSION['id'] = $data['id'];
        echo"
				<a href='single.php?&id=" . $data['id'] . "&jenis=" . $_SESSION['jenis'] . "&in=" . $_SESSION['in'] . "&out=" . $_SESSION['out'] . "&jumlah=" . $_SESSION['jumlah'] . "&harga=" . $_SESSION['harga'] . "' class='btn3'>Rent</a>;
        "
        ?>
